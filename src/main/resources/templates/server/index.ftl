...
<div id="server_info" v-loading="loading">
    ...
    <el-table :data="serverList" style="width: 100%" stripe>
        ...
        <!-- 服务器ID -->
        <el-table-column v-if="isColumnVisible('serverId')" label="服务器ID" prop="serverId"></el-table-column>
        <!-- 服务器名称 -->
        <el-table-column v-if="isColumnVisible('serverName')" label="服务器名称" prop="serverName"></el-table-column>
        <!-- 服务器IP -->
        <el-table-column v-if="isColumnVisible('serverIp')" label="服务器IP" prop="serverIp"></el-table-column>
        <!-- 房间ID -->
