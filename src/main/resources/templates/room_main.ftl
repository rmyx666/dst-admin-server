...
<head>
    ...
    <script src="/js/room_main.js" charset="utf-8"></script>
</head>
                ...
                <div class="layui-nav-child">
                    <div class="timo-nav-child-box">
                        <div style="margin-top: 20px;text-align: center">
                            <a style="font-size: 1em;color: #444444" class="changeLang"
                ...
                <div class="layui-nav-child">
                    <div class="timo-nav-child-box">
                        ...
                        <div><a class="open-popup" data-title="<@spring.message code="main.logo.editPwd"/>"
                                ...
                                <i class="fa fa-lock"
                                   style="font-size:17px;width:12px;"></i><@spring.message code="main.logo.editPwd"/>
                            </a>
                        </div>
                        <div><a href="/logout"><i class="fa fa-power-off"></i><@spring.message code="main.logo.logout"/>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <#if treeMenu2?exists>
                    <#list treeMenu2?keys as key>
                        <li class="layui-nav-item">
                            ...
                            <#if treeMenu2[key].children?exists>
